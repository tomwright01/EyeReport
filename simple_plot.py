...
defaults = [{'name': 'DA 0.01', 'desc': 'Dark-adapted 0.01 ERG', 'ylims': (-100,250)},
...
def get_step_options(data, steps):
    ...
    for step in steps:
        print('step:{}'.format(data[step].description))

        step_data = data[step]
        default = find_default(step_data.description)
...
if __name__ == '__main__':
    ...
    data = [data_merged[step] for step in steps]
